...
public class DefaultRefStrategyTest {
    ...
    public void usesDefaultPointer() {
        RefStrategy ref = RefStrategy.createDefaultStrategy(
                ShapeIndex.builder().build(), Node.objectNode(), propertyNamingStrategy);
    ...
    public void usesCustomPointerAndAppendsSlashWhenNecessary() {
        RefStrategy ref = RefStrategy.createDefaultStrategy(ShapeIndex.builder().build(), Node.objectNodeBuilder()
    ...
    public void addsListAndSetMembers() {
        ...
        ListShape list = ListShape.builder()
                ...
                .member(member)
                .build();
        ShapeIndex index = ShapeIndex.builder().addShapes(string, list, member).build();
        RefStrategy ref = RefStrategy.createDefaultStrategy(index, config, propertyNamingStrategy);
    ...
    public void addsMapMembers() {
        ...
        MapShape map = MapShape.builder()
                ...
                .value(value)
                .build();
        ShapeIndex index = ShapeIndex.builder().addShapes(string, map, key, value).build();
        RefStrategy ref = RefStrategy.createDefaultStrategy(index, config, propertyNamingStrategy);
    ...
    public void addsStructureMembers() {
        ...
        StructureShape struct = StructureShape.builder()
                ...
                .addMember(member)
                .build();
        ShapeIndex index = ShapeIndex.builder().addShapes(string, struct, member).build();
        RefStrategy ref = RefStrategy.createDefaultStrategy(index, config, propertyNamingStrategy);
